...
namespace OpenStrata.Xrm.Sdk
{
	...
	public partial class Publisher : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<OpenStrata.Xrm.Sdk.Solution> publisher_solution
		{
			get
			{
				return this.GetRelatedEntities<OpenStrata.Xrm.Sdk.Solution>("publisher_solution", null);
			}
			set
			{
				this.SetRelatedEntities<OpenStrata.Xrm.Sdk.Solution>("publisher_solution", null, value);
			}
		}
		...
		public OpenStrata.Xrm.Sdk.Organization organization_publisher
		{
			get
			{
				return this.GetRelatedEntity<OpenStrata.Xrm.Sdk.Organization>("organization_publisher", null);
			}
		}
	}
}
