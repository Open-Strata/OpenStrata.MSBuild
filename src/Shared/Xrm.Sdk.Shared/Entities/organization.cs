...
namespace OpenStrata.Xrm.Sdk
{
	...
	public partial class Organization : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<OpenStrata.Xrm.Sdk.Publisher> organization_publisher
		{
			get
			{
				return this.GetRelatedEntities<OpenStrata.Xrm.Sdk.Publisher>("organization_publisher", null);
			}
			set
			{
				this.SetRelatedEntities<OpenStrata.Xrm.Sdk.Publisher>("organization_publisher", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<OpenStrata.Xrm.Sdk.Solution> organization_solution
		{
			get
			{
				return this.GetRelatedEntities<OpenStrata.Xrm.Sdk.Solution>("organization_solution", null);
			}
			set
			{
				this.SetRelatedEntities<OpenStrata.Xrm.Sdk.Solution>("organization_solution", null, value);
			}
		}
	}
}
